...
# ================= general ================= #
CFG.DESCRIPTION = "STELLA model configuration"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "STELLA"
CFG.MODEL.ARCH = STELLA
NUM_NODES = 1316
CFG.MODEL.PARAM = EasyDict(
    {
        ...
        "if_rel": False,
        "res_conn": True,
        "root_path": "./datasets/ChinaPM25",
        "dropout": 0.2,
    }
)
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]    # [raw_data, time_of_day, day_of_month, month_of_year]
