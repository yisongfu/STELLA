...
CFG.MODEL.PARAM = EasyDict(
    ...
    "root_path": "./datasets/ChinaTemp",           # root path of the location file of stations
    "activation": "gelu",
...
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]    # [raw_data, time_of_day, day_of_week, day_of_month, day_of_year]
