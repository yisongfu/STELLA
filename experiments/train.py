...
def parse_args():
    ...
    parser.add_argument("-c", "--cfg", default="baselines/STELLA/STELLA_ChinaWind.py", help="training config")
    # parser.add_argument("-c", "--cfg", default="baselines/STELLA/STELLA_ChinaTemp.py", help="training config")
